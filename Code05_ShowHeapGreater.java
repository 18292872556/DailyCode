...
public class Code05_ShowHeapGreater {
    ...
    public static void main(String[] args) {
        ...
        Student s2 = new Student(19, "学生B");
        Student s3 = new Student(17, "学生C");
        Student s4 = new Student(35, "学生D");
        Student s5 = new Student(54, "学生E");
        //生成一个加强堆，排序策略是年龄小的在堆顶，年龄小根堆。参数用lambda表达式
        Code06_HeapGreater<Student> heap1 = new Code06_HeapGreater<>((a, b) -> a.age - b.age);
        //把所有学生入堆
        heap1.push(s1);
        heap1.push(s2);
        heap1.push(s3);
